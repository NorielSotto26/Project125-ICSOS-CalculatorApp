...
void gray(int x, int y){ //prints a gray bulb socket 
int i;
	for (i=0;i<25;i++)write_pixel(i+x,0+y,56);
	for (i=0;i<25;i++)write_pixel(i+x,1+y,56);
	for (i=0;i<25;i++)write_pixel(i+x,2+y,56);
	for (i=0;i<25;i++)write_pixel(i+x,3+y,56);
	for (i=0;i<25;i++)write_pixel(i+x,4+y,56);
	for (i=0;i<25;i++)write_pixel(i+x,5+y,56);
	for (i=0;i<25;i++)write_pixel(i+x,6+y,56);
	...
	for (i=0;i<25;i++)write_pixel(i+x,12+y,56);
	for (i=0;i<25;i++)write_pixel(i+x,13+y,56);
	for (i=0;i<25;i++)write_pixel(i+x,14+y,56);
	for (i=0;i<25;i++)write_pixel(i+x,15+y,56);
	for (i=0;i<25;i++)write_pixel(i+x,16+y,56);
	for (i=0;i<25;i++)write_pixel(i+x,17+y,56);
	for (i=0;i<25;i++)write_pixel(i+x,18+y,56);
